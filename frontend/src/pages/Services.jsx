    ...
    <div className="min-h-screen bg-gray-50 py-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center mb-10 gap-4">
          <h1 className="text-3xl font-bold text-gray-900 tracking-tight">Our Services</h1>
            ...
            <div key={service.id} className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow group flex flex-col">
              <div className="relative">
                {service.image_url ? (
                  ...
                  <img src={getDefaultImage(service.category)} alt="Default Service" className="w-full h-52 object-cover" />
                )}
